...
if (isset($_REQUEST['btn'])) {
	...
	$registrar = mysqli_query($conexion,"INSERT INTO producto(producto,idproveedor,stock) VALUES ('$nombre','$idproveedor','$stock')") or die($conexion. "Problemas en el insert");
